...
.. |Travis CI build status| image:: https://travis-ci.org/analyticslane/minimalcryptocurrency.svg?branch=master
   :target: https://travis-ci.org/analyticslane/minimalcryptocurrency
.. |Requirements Status| image:: https://requires.io/github/analyticslane/minimalcryptocurrency/requirements.svg?branch=develop
   :target: https://requires.io/github/analyticslane/minimalcryptocurrency/requirements/?branch=develop
.. |Codecov Code Coverage| image:: https://codecov.io/gh/analyticslane/minimalcryptocurrency/branch/master/graph/badge.svg
   :target: https://codecov.io/gh/analyticslane/minimalcryptocurrency
.. |Scrutinizer Code Quality| image:: https://scrutinizer-ci.com/g/analyticslane/minimalcryptocurrency/badges/quality-score.png?b=master
   :target: https://scrutinizer-ci.com/g/analyticslane/minimalcryptocurrency/?branch=master
.. |Codacy Badge| image:: https://api.codacy.com/project/badge/Grade/23fe4d509e9e4e68a14723ae808f8e10
   :target: https://www.codacy.com/app/analyticslane/minimalcryptocurrency?utm_source=github.com&utm_medium=referral&utm_content=analyticslane/minimalcryptocurrency&utm_campaign=Badge_Grade
